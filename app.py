...
def generate_story(scenario):
    ...
    You can generate a simple story based on a simple narrative, the story should be not more than 30 words;
...
def main():
    ...
    if uploaded_file is not None: 
        ...
        st.image(uploaded_file, caption='Uploaded Img. ', use_column_width=True)
